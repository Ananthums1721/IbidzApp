...
export const getHotAuctions = async () => {
  ...
  const URL = `?sp=getHotAuctions&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
  let banner = await get(URL);
  return banner;
};
...
export const getTodaysHotAuctions = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getTodaysAuctions&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
  let banner = await get(URL);
  return banner;
};
...
export const getPermiumHotAuctions = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getPremiumAuction&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
  let banner = await get(URL);
  return banner;
};
...
export const getauctionList = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getAuctionsList&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getUpcomingauctionList = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getUpcomingAuctions&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
  let List = await get(URL);
  return List;
};
...
export const getProfileDetails = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getCustomerProfileById&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getPackageListData = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getCustomerPackagesList&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
  let details = await get1(URL);
  return details;
};
...
export const getDashBoardData = async () => {
  ...
  const URL = `?sp=getDashboardProfileFe&Id=${profile[0]?.customerId ? profile[0]?.customerId : ""}&multiple=${true}&type=${type}`;
...
export const getPackageHis = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getCustomerPackageHistory&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getMyBidData = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getCustomerBids&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getPaymentDues = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getPaymentDue&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
  let myBid = await get1(URL);
  return myBid;
};
...
export const getPaymentHistory = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getPackageHistory&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getWishList = async () => { 
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getCustomerWishlists&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getProcessWin = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getProcessWinningsAgainstCustomer&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getWinnings = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getCustomerWinnings&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getclaimAmount = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getclaimamount&custId=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getVendorProfile = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getSellerProfileById&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
...
export const getVendorDashBoardData = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  let type =  await AsyncStorage.getItem('userType');
  const URL = `?sp=getDashboardProfileFe&Id=${profile[0]?.sellerId? profile[0]?.sellerId : ""}&multiple=${true}&type=${type}`;
  let dashboard = await get(URL);
  return dashboard;
}
...
export const getVendorAuction = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getSellerLiveAuctionsList&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
...
export const getVendorAuctionHistory = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getSellerAuctionsList&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
...
export const getVendorProcessWin = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getProcessWinnersAgainstSellerAuctions&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
  let process = await get1(URL);
  return process;
};
...
export const getVendorAuctionWon = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getWonCustomersAgainstSellerAuctions&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
...
export const getVendorPaymentHistory = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getPendingPaymentHistoryAgainstSellerId&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
...
export const getVendorLostAuction = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getLostAuction&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
...
export const getVendorPendingPayment = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getPaymentHistoryAgainstSellerId&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
  let payment = await get1(URL);
  return payment;
};
...
export const getNotification = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getNotificationList&Id=${profile[0]?.customerId ? profile[0]?.customerId : ""}`;
...
export const getVehicleList = async () => {
  let profile = JSON.parse(await AsyncStorage.getItem('profile'));
  const URL = `?sp=getVehiclesListBySellerId&sellerId=${profile[0]?.sellerId ? profile[0]?.sellerId : ""}`;
