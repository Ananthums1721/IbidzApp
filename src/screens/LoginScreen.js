        ...
        <ScrollView showsVerticalScrollIndicator={false}
          ...
          <View style={styles.innerContainer}>
            <View >
              ...
              <Text style={[styles.fontStyle3, { paddingBottom: 5, textAlign: 'center' }]}>Login as Buyer</Text>
            ...
            <View style={{ marginBottom: windowHeight * (10 / 100) }}>
              <View style={{ flexDirection: 'row', width: windowWidth, justifyContent: 'center' }}>
                ...
                <Text style={[styles.fontStyle2, { color: colours.blue, fontFamily: 'Poppins-Bold', textDecorationLine: 'underline' }]} onPress={() => navigation.navigate('RegisterScreen')}> Register</Text>
              </View>

              <View style={{ flexDirection: 'row', width: windowWidth, justifyContent: 'center' }}>

                <Text style={styles.fontStyle2}> Sign as</Text>
                <Text style={[styles.fontStyle2, { color: colours.blue, fontFamily: 'Poppins-Bold', textDecorationLine: 'underline' }]} onPress={() => navigation.navigate('VendorLoginScreen')}> Seller</Text>
              </View>
            </View>
          </View>
          {/* </ImageBackground> */}
