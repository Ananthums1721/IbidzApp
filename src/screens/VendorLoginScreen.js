...
import { SafeAreaView, StyleSheet, View, Text, Dimensions, Linking, Image, TouchableOpacity, KeyboardAvoidingView, ScrollView, Modal, ImageBackground } from 'react-native';
    ...
    const handleVendorLogin = async () => {
        ...
        if (!(EmailError || PasswordError || emailError)) {
            try {
                ...
                let res = await login({
                    sp: "getSellerAuth",
                    username: status == 'email'? email : email.split(`+${phoneCCode.CountryCode}`).join(`+${phoneCCode.CountryCode}-`),
                    password: password
                });
                showLoader(false);
            ...
            >
                <ScrollView showsVerticalScrollIndicator={false}
                    ...
                    <View style={styles.innerContainer}>
                        ...
                        <View >
                            <Text style={[styles.fontStyle3, { paddingBottom: 5, textAlign: 'center', fontSize: getFontontSize(16) }]}>Welcome to ibidz !</Text>
                            <Text style={[styles.fontStyle3, { paddingBottom: 5, textAlign: 'center' }]}>Login as Vendor</Text>
                            <View style={{paddingVertical: windowHeight*(1/100)}}>
                                <SwitchSelector
                                    ...
                                    hasPadding
                                    selectedTextStyle={[styles.fontStyle2,{color:colours.primaryWhite}]}
                            ...
                            <Text style={styles.forgot} onPress={() => navigation.navigate('VendorForgotPassword')}>Forgot Password ?</Text>
                        ...
                        <View style={{marginBottom:windowHeight*(10/100)}}>
                            <View style={{ flexDirection: 'row', width: windowWidth, justifyContent: 'center' }}>
                                ...
                                <Text style={[styles.fontStyle2, { color: colours.blue, fontFamily: 'Poppins-Bold', textDecorationLine: 'underline' }]} onPress={() => navigation.navigate('VendorRegister')}> Register</Text>
                            </View>

                            <View style={{ flexDirection: 'row', width: windowWidth, justifyContent: 'center' }}>

                                <Text style={styles.fontStyle2}> Sign as</Text>
                                <Text style={[styles.fontStyle2, { color: colours.blue, fontFamily: 'Poppins-Bold', textDecorationLine: 'underline' }]} onPress={() => navigation.goBack()}> Customer</Text>
                            </View>
                        </View>
                    </View>
                    {/* </ImageBackground> */}
