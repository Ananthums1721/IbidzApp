import { View, Text, RefreshControl, SafeAreaView, StyleSheet, Dimensions, TouchableOpacity, FlatList, ScrollView, Image } from 'react-native'
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.profileDataView}>
          <TouchableOpacity style={styles.profileDtatViewCon} onPress={()=>navigation.navigate('ActiveAuction')}>
          ...
          <TouchableOpacity style={styles.profileDtatViewCon} onPress={()=>navigation.navigate('WonCustomers')}>
          ...
          <TouchableOpacity style={styles.profileDtatViewCon} onPress={()=>navigation.navigate('PendingPayment')}>
        ...
        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('AddVehicle')} >
          <View style={styles.menuCon}>{showIcon('carPlus', colours.primaryBlack, 16)}</View>
          <Text style={styles.componentText}>Add Vehicles</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('Vehicle')} >
          <View style={styles.menuCon}>{showIcon('car', colours.primaryBlack, 16)}</View>
          <Text style={styles.componentText}>Vehicles</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('ActiveAuction')}>
          <View style={styles.menuCon}>{showIcon('sandtimer', colours.primaryBlack, 16)}</View>
          <Text style={styles.componentText}>Active Auctions</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('AuctionHistory')} >
        ...
        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('WonCustomers')}>
        ...
        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('PendingPayment')}>
          <View style={styles.menuCon}>{showIcon('pendingpayment', colours.primaryBlack, 16)}</View>
          <Text style={styles.componentText}>Pending Payment</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('PaymentHistory')}>
          <View style={styles.menuCon}>{showIcon('claim', colours.primaryBlack, 16)}</View>
          <Text style={styles.componentText}>Payment History</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.componentView} onPress={() => navigation.navigate('Lost')}>
          <View style={styles.menuCon}>{showIcon('lost', colours.primaryBlack, 16)}</View>
          <Text style={styles.componentText}>Lost</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.componentView}
        ...
        <TouchableOpacity style={styles.componentView} onPress={() => {toggleModal() }}>
