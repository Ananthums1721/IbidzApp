        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.head}>
                    <Text style={styles.fontText1}>About Us</Text>
                </View>
                {
                    terms != '' ?
                        <>
                            <View style={styles.subboxText}>
                                ...
                                <View style={{ width: windowWidth * (90 / 100), alignItems: 'flex-end' }}>
                                    <TouchableOpacity onPress={() => navigation.navigate('FeedBack')} style={styles.contactBox}>
                                        <Text style={styles.fontText2}>Contact Us</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
